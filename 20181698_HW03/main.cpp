...
void compose_imgui_frame()
{
  ...
  // control window
  {
    ...
    ImGui::gizmo3D("rotation", g_quat_model_rotation, 100, imguiGizmo::mode3Axes);
    ImGui::SliderFloat3("scale", &g_vec_model_scale[0], 0, 3.0f);
    ImGui::End();
  }
...
void init_scene()
{
  ...
  g_quat_model_rotation = glm::quat(glm::vec3(0.0f, 0.0f, 0.0f));
